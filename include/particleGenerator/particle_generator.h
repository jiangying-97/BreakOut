 ...
 ******************************************************************************/
#define DEBUG_PARTICLE_GENERATOR
/******************************************************************************
 ...
 ******************************************************************************/
#ifndef _PARTICLE_GENERATOR_CPP_
#define PARTICLE_GENERATOR_EXT extern
#else
#define PARTICLE_GENERATOR_EXT
#endif
/******************************************************************************
...
struct Particle {
	...
	Particle() : Position(0.0f), Velocity(0.0f), Color(0.8f,0.5f,0.7f,1.0f), Life(0.0f) { }
};
